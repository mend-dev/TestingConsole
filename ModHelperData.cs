...
public static class ModHelperData {
    ...
    public const string Description = "This mod adds a console for TESTING PURPOSES\n" +
        "This will ONE MILLION PERCENT get you flagged\n" +
        "I made this so I can test the game while making mods much easier (BTD6Rogue, go check it out)\n" +
        "\n" +
        "Currently commands exist for:\n" +
        "- Spawning Bloons\n" +
        "- Spawning Towers\n" +
        "- Setting In Game Cash\n" +
        "- Setting In Game Lives\n" +
        "- Setting In Game Round\n" +
        "\n" +
